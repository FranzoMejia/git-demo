...
export class CatalogoComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.catalogoService
      ...
      .subscribe({
        next: (res: HttpResponse<ICatalogo[]>) => {
  ...
  trackId(_index: number, item: ICatalogo): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: ICatalogo[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
