...
export class PedidoService {
  ...
  protected convertDateFromClient(pedido: IPedido): IPedido {
    return Object.assign({}, pedido, {
      fechaGenerado: pedido.fechaGenerado?.isValid() ? pedido.fechaGenerado.format(DATE_FORMAT) : undefined,
  ...
  protected convertDateFromServer(res: EntityResponseType): EntityResponseType {
    if (res.body) {
      res.body.fechaGenerado = res.body.fechaGenerado ? dayjs(res.body.fechaGenerado) : undefined;
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((pedido: IPedido) => {
        pedido.fechaGenerado = pedido.fechaGenerado ? dayjs(pedido.fechaGenerado) : undefined;
