...
import com.admintool.app.domain.Cliente;
import com.admintool.app.repository.ClienteRepository;
...
class ClienteResourceIT {
    ...
    public static Cliente createEntity(EntityManager em) {
        Cliente cliente = new Cliente().nombre(DEFAULT_NOMBRE).telefono(DEFAULT_TELEFONO);
        return cliente;
    }
    ...
    public static Cliente createUpdatedEntity(EntityManager em) {
        Cliente cliente = new Cliente().nombre(UPDATED_NOMBRE).telefono(UPDATED_TELEFONO);
        return cliente;
    }
    ...
    void putNewCliente() throws Exception {
        ...
        updatedCliente.nombre(UPDATED_NOMBRE).telefono(UPDATED_TELEFONO);
    ...
    void fullUpdateClienteWithPatch() throws Exception {
        ...
        partialUpdatedCliente.nombre(UPDATED_NOMBRE).telefono(UPDATED_TELEFONO);
