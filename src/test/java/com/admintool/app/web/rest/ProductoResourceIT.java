...
class ProductoResourceIT {
    ...
    public static Producto createEntity(EntityManager em) {
        Producto producto = new Producto().producto(DEFAULT_PRODUCTO).precio(DEFAULT_PRECIO);
        return producto;
    }
    ...
    public static Producto createUpdatedEntity(EntityManager em) {
        Producto producto = new Producto().producto(UPDATED_PRODUCTO).precio(UPDATED_PRECIO);
        return producto;
    }
    ...
    void putNewProducto() throws Exception {
        ...
        updatedProducto.producto(UPDATED_PRODUCTO).precio(UPDATED_PRECIO);
    ...
    void partialUpdateProductoWithPatch() throws Exception {
        ...
        partialUpdatedProducto.producto(UPDATED_PRODUCTO).precio(UPDATED_PRECIO);
